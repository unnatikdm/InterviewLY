# InterviewLY: AI-Powered Interview Performance Analyzer
...
1. **Upload** your interview video (mock or real)
2. **Select** analysis modules based on your focus areas
3. **Process** using lightweight AI models
4. **Review** detailed feedback with scores and visualizations
5. **Improve** with actionable suggestions for enhancement
...
- **YouTube Demo**: [https://youtu.be/tLitcbYDeAo](https://youtu.be/tLitcbYDeAo)
